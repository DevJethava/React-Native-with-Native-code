...
public abstract class ActivityNet extends ReactActivity {
            ...
            if (ni != null) {
                ...
                if (ni.getDetailedState() == NetworkInfo.DetailedState.CONNECTED) {
                    ...
                    if (type == ConnectivityManager.TYPE_WIFI) { // WIFI
                        ...
                        if (prefs.getBoolean(Constant.KEY_MOBILE, Constant.DEFAULT_MOBILE)
                                || prefs.getString(Constant.KEY_INTF, Constant.DEFAULT_INTF) != null) {
                            net.getMobileInfo();
                            if (net.carrier != null) {
                                net.getIp();
                                info_ip_str = getString(R.string.net_ip, net.ip, net.cidr, net.intf);
